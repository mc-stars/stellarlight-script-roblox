...
for _,v in pairs(CoreGui:GetChildren())do if v.Name=="Stellarlight"then v:Destroy()end end
for _,v in pairs(LocalPlayer.PlayerGui:GetChildren())do if v.Name=="Stellarlight"then v:Destroy()end end
...
local Lang={
    CN={
        ...
        Loaded="加载完成",
        Welcome="欢迎使用 Stellarlight 管理员菜单"
    },
    EN={
        Logo="Stellarlight",
        Player="Player",
        ...
        Welcome="Welcome to Stellarlight Admin Menu"
    }
}
...
PlayerNav.MouseButton1Click:Connect(function()LoadPlayerTab()end)
VisualNav.MouseButton1Click:Connect(function()LoadVisualTab()end)
GameNav.MouseButton1Click:Connect(function()LoadGameTab()end)
ToolsNav.MouseButton1Click:Connect(function()LoadToolsTab()end)
SettingsNav.MouseButton1Click:Connect(function()LoadSettingsTab()end)
